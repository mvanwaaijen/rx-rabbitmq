...
/***
 * Defines a Routing Exchange. Emits a subject with which you can add messages to the exchange
 ...
 */
const routingSubmitter$ = (conn, exchange) => {
...
module.exports = { routingReceiver$, routingSubmitter$ }
